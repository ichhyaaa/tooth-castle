                              ...
                              <div class="flex items-center">
                                ...
                                <div class="relative w-full">
                                  <div class="w-full bg-gray-200 rounded-sm h-2">
                                    <div class="bg-cyan-600 h-2 rounded-sm w-300"></div>
                                  </div>
                                </div>
                              </div>
                            </td>
                          ...
                          <tr class="text-gray-500">
                            ...
                            <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                              <div class="flex items-center">
                                ...
                                <div class="relative w-full">
                                  <div class="w-full bg-gray-200 rounded-sm h-2">
                                    <div class="bg-orange-300 h-2 rounded-sm w-240"></div>
                                  </div>
                                </div>
                              </div>
                            </td>
                          ...
                          <tr class="text-gray-500">
                            ...
                            <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                              <div class="flex items-center">
                                ...
                                <div class="relative w-full">
                                  <div class="w-full bg-gray-200 rounded-sm h-2">
                                    <div class="bg-teal-400 h-2 rounded-sm w-180"></div>
                                  </div>
                                </div>
                              </div>
                            </td>
                          ...
                          <tr class="text-gray-500">
                            ...
                            <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                              <div class="flex items-center">
                                ...
                                <div class="relative w-full">
                                  <div class="w-full bg-gray-200 rounded-sm h-2">
                                    <div class="bg-pink-600 h-2 rounded-sm w-120"></div>
                                  </div>
                                </div>
                              </div>
                            </td>
                          ...
                          <tr class="text-gray-500">
                            ...
                            <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                              <div class="flex items-center">
                                ...
                                <div class="relative w-full">
                                  <div class="w-full bg-gray-200 rounded-sm h-2">
                                    <div class="bg-indigo-600 h-2 rounded-sm w-900"></div>
                                  </div>
                                </div>
                              </div>
                            </td>
                          ...
                          <tr class="text-gray-500">
                            ...
                            <td class="border-t-0 align-middle text-xs whitespace-nowrap p-4 pb-0">
                              <div class="flex items-center">
                                ...
                                <div class="relative w-full">
                                  <div class="w-full bg-gray-200 rounded-sm h-2">
                                    <div class="bg-purple-500 h-2 rounded-sm w-700"></div>
                                  </div>
                                </div>
                              </div>
                            </td>
