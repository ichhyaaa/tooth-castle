...
export default function SignUp() {
  ...
  const handleSubmit = (e) => {
    ...
    if (password.length < 8 || password.length > 32) {
      errors.password = "Password must be between 8 and 32 characters"; // Add error message to errors object
    }

    if (password !== confirmPassword) {
      errors.confirmPassword = "Passwords do not match"; // Add error message to errors object
    }
