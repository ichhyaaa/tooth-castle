...
export const Login = () => {
  ...
  <>
     <div className="bg-">
      ...
      <div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-20">
        <div class="relative bg-white px-6 pt-2 pb-9 shadow-xl mx-auto w-full max-w-lg rounded-2xl">
