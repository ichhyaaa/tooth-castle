  ...
  return (
    <div className="bg-">
            ...
            <div class="flex items-center">
              <div class="w-1/2">
                ...
                <p class="text-xl mb-5">
                  ...
                  where I could see my vision come to life. </p>
                  <p class="text-xl mb-5"> 
                Offering a unique
                  and relaxing atmosphere with state-of-the-art equipment, we
                  wished to provide a service that went above and beyond the
                  usual dental care experience many people have become used to.
                  </p>
                  <p class="text-xl mb-5">
      ...
      <div class="relative flex  flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
        <div class="w-full items-center mx-auto max-w-screen-lg">
          <div class="group grid w-full grid-cols-2">
            <div class="pr-16 relative flex items-end flex-col before:block">
              <div class="rounded-xl overflow-hidden">
                <img src={doctor2} alt="" />
              </div>
            </div>
      ...
      <div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
        <div class="w-full items-center mx-auto max-w-screen-lg">
          <div class="group grid w-full grid-cols-2">
            <div>
              <div class="pr-12">
                <p class="peer mb-6 text-gray-400">11111111111111</p>
                <p class="mb-6 text-gray-400">22222222222222</p>
                <h3 class="mb-4 font-semibold text-xl text-gray-400">
                  Importance of using
                </h3>
                <ul
